...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Entre 6 - 7 horas en autos,  entre 2,5 - 3 horas en motos.',
  },
  {
...
const Contactos: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contacto Smart Drive | Movilidad eléctrica</title>
        <meta
          name="description"
          content="Contáctanos para conocer cómo acceder a vehículos eléctricos con Smart Drive. Visítanos en nuestras oficinas o escríbenos por WhatsApp."
        />
      </Helmet>
